        ...
        <template #body>
            ...
            >
                ...
                <UPageGrid class="lg:grid-cols-2 gap-6">
                    ...
                    >
                        <div
                            v-if="subscriptionChartData.length > 0"
                            class="space-y-4"
                        >
                            <div
                                v-for="(item, index) in subscriptionChartData"
                                :key="item.name"
                                class="flex items-center gap-4"
                            >
                                <div class="flex-1">
                                    <div class="flex justify-between items-center mb-1">
                                        <div class="flex items-center gap-2">
                                            <div
                                                ...
                                                :class="[index === 0 ? 'bg-blue-500' : '', index === 1 ? 'bg-green-500' : '', index === 2 ? 'bg-purple-500' : '', index >= 3 ? 'bg-orange-500' : '']"
                                            />
