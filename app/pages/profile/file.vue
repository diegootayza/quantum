...
<template>
    <UDashboardPanel id="profile-file">
        ...
        <template #body>
            ...
            <div v-if="items.length === 0" class="flex flex-col items-center justify-center py-16 px-4">
                <div class="flex flex-col items-center gap-4 max-w-md text-center">
                    <div class="p-4 rounded-full bg-gray-100 dark:bg-gray-800">
                        <UIcon name="i-lucide-folder-open" class="w-12 h-12 text-gray-400 dark:text-gray-600" />
                    </div>
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Aún no has subido ningún archivo. Los archivos que subas en tus conversaciones aparecerán aquí.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <!-- Files Grid -->
            <div v-else class="w-full grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-4">
                <UCard
